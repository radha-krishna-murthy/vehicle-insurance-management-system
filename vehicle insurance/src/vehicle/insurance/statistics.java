...
public class statistics extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setPreferredSize(new java.awt.Dimension(600, 450));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select issue.customerID,customer.name,issue.policyID,policy.policyName,issue.issueDate,issue.dueDate from customer inner join policy inner join issue where policy.policyID=issue.policyID and customer.customerID=issue.customerID and issue.returnInsurance='NO'");
